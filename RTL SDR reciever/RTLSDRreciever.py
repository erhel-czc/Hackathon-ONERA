...
class RTLSDRreciever(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "RTLSDRreciever", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("RTLSDRreciever")
        ...
        self._freq_range = qtgui.Range(87.7e6, 107.9e6, 200e3, 90.4e6, 200)
...
def main(top_block_cls=RTLSDRreciever, options=None):
